        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InquaryHeaderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InquiryDetail_InquiryHeader_InquaryHeaderId",
                        column: x => x.InquaryHeaderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InquiryDetail_InquaryHeaderId",
                table: "InquiryDetail",
                column: "InquaryHeaderId");
